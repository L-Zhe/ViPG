...
class checkpoint:
    ...
    def __init__(self, save_path=None, checkpoint_num=inf, save_n_epoch=1, restore_file=None):
    ...
    def save_point(self, model, optim, epoch):
        ...
        if self.checkpoint_num != 1 and epoch % self.save_n_epoch == 0:
    ...
    def restore(self):
        ...
        if self.restore_file and os.path.exists(self.restore_file):
            ...
            self.checkpoint_cnt = point['checkpoint_cnt'] + 1
