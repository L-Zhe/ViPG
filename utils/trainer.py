...
def get_checkpoint(args):
    ...
    check_point = checkpoint(save_path=args.checkpoint_path,
                             ...
                             save_n_epoch=args.checkpoint_n_epoch,
...
def get_dataloader(args, seed):
    ...
    setattr(args, 'data_len', len(train_loader))
...
def get_model(args, model_state_dict, optim_state_dict):
    ...
    # ViT = ViTModel.from_pretrained(args.vis_pretrain_file).cuda()
    # ViT.eval()
    # setattr(args, 'ViT', ViT)
