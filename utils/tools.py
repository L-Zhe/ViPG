...
def save_vocab(word2index, index2word, lower, relation_index, pos_index, save_path):
...
def load_vocab(save_path):
    with open(save_path, 'rb') as f:
        vocab = pickle.load(f)
    return vocab['word2idx'], vocab['idx2word'], vocab['lower'], vocab['relation_index'], vocab['pos_index']
    # return vocab['word2idx'], vocab['idx2word'], vocab['lower'], vocab['word2idx']['<relation>'], vocab['word2idx']['<pos_dict>']
